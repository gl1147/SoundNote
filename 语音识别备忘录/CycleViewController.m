...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        [cycleScrollView setTapActionBlock:^(NSInteger(pageIndex)) {
            ...
            NSLog(@"click on page%ld",(long)pageIndex);
    ...
    if(indexPath.section == 1){
        ...
        cell.textLabel.text =@"wall paper";
...
-(void)btn1 {
    ...
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:nil message:@"wall setting complete" delegate:nil cancelButtonTitle:@"ok" otherButtonTitles:nil, nil];
    [alert show];
