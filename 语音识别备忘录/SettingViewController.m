...
-(void)pasteT:(NSString *)text {
    ...
    NSString *data = [NSString stringWithFormat:@"%@copied",text];
    
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:nil message:data delegate:nil cancelButtonTitle:@"ok" otherButtonTitles:nil, nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc]initWithTitle:nil delegate:self cancelButtonTitle:@"cancel" destructiveButtonTitle:@"copy" otherButtonTitles:nil, nil];
    ...
    if (tag == 0) {
        ...
        UIAlertView *call = [[UIAlertView alloc]initWithTitle:@"to customer service" message:@"dial:917-657-1194?" delegate:self cancelButtonTitle:@"no" otherButtonTitles:@"yes", nil];
